...
Are you sure you want to delete the following student? <br />
<form action="delete-details.asp" method="get">
	NAME: <input disabled type="text" name="name" value="<%=std_name%>" >
	COURSE: <input disabled  type="text" name="course" value="<%=std_course%>" >
